...
/**
   \mainpage Aether3D Game Engine v0.8.9 Documentation
   ...
   Grab the <a href="https://twiren.kapsi.fi/files/aether3d_sample_v0.8.9.zip">sample asset archive</a> and extract it into aether3d_build/Samples after building.
